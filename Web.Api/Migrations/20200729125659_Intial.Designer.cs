...
namespace Web.Api.Migrations
{
    ...
    [Migration("20200729125659_Intial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Web.Shared.Data.Address", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Web.Shared.Data.EmergencyContact", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Web.Shared.Data.Employee", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Web.Shared.Data.EmploymentInfo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Web.Shared.Data.Immigration", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Web.Shared.Data.EmploymentInfo", b =>
                {
                    b.HasOne("Web.Shared.Data.Employee", "Employee")
                        .WithOne("EmploymentInfo")
                        .HasForeignKey("Web.Shared.Data.EmploymentInfo", "EmployeeId");
                });
            ...
            modelBuilder.Entity("Web.Shared.Data.Immigration", b =>
                {
                    b.HasOne("Web.Shared.Data.Employee", "Employee")
                        .WithOne("Immigration")
                        .HasForeignKey("Web.Shared.Data.Immigration", "EmployeeId");
                });
